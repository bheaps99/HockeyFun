...
namespace HockeyFun.Data.Migrations
{
    public partial class M1 : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "Players",
                columns: new[] { "PlayerId", "FirstName", "LastName", "MyProperty", "Position", "TeamName" },
                values: new object[,]
                {
                    { 1, "Sven", "Baertschi", 0, "Forward", "Canucks" },
                    { 2, "Hendrik", "Sedin", 0, "Left Wing", "Canucks" },
                    { 4, "Bob", "Plumber", 0, "Defense", "Oilers" },
                    { 3, "John", "Rooster", 0, "Right Wing", "Flames" }
                });
